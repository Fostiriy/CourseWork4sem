...
namespace CW_ThoughtsOutLoud
{
	...
	public class Node
	{
		public Node Next;   // Элемент, следующий за данным
	...
	class HashTable
	{
		...
		private RingLinkedList[] items;				// Массив цепочек
		...
		public bool Remove(int key)
		{
			...
			Node keyThere = itemsWithSameHashCode.Find(key);
